...
export function generateTypeScript(
  ...
  lines.push('// Auto-generated by env-guardian-cli. Do not edit manually.');
  lines.push('// Regenerate with: npx env-guardian-cli generate');
  lines.push('');
...
export function generateEnvExample(schema: EnvSchema, options: { comments?: boolean } = {}): string {
  ...
  if (showComments) {
    ...
    lines.push('# Generated by env-guardian-cli');
    lines.push('');
  }
